"""
Django settings for red_block_42542 project.
...
ROOT_URLCONF = 'red_block_42542.urls'
...
WSGI_APPLICATION = 'red_block_42542.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_block_42542 API",
    "DESCRIPTION": "API documentation for red_block_42542 App",
    "VERSION": "v1",
}
